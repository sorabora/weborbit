...
function draw() {
  ...
  if (curRocket) {
    ...
    text(`Throttle: ${throttle}%`, 25, 50 + lineHeight * 8)
    text(`Fuel: ${calculateFuel()}`, 25, 50 + lineHeight * 9)
    text(`TWR: ${calculateTWR()}`, 25, 50 + lineHeight * 10)
    text(`Pitch: ${calculatePitch()}`, 25, 50 + lineHeight * 11)
    text(`G force: ${calculateG()}`, 25, 50 + lineHeight * 12)
  } else {
